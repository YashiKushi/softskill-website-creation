    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            id: 7,
            title: "Практическое задание: Калькулятор",
            duration: "45 мин",
            completed: true,
            type: "text",
          },
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            id: 11,
            title: "Практическое задание: Библиотека книг",
            duration: "60 мин",
            completed: false,
            type: "text",
          },
    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            id: 5,
            title: "Передача данных через props",
            duration: "25 мин",
            completed: false,
            type: "video",
          },
          ...
          {
            id: 7,
            title: "Практическое задание: Карточки пользователей",
            duration: "55 мин",
            completed: false,
            type: "text",
          },
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            Извините, запрашиваемый курс не существует.
          </p>
          <Link to="/dashboard">
        ...
        <Tabs defaultValue="content">
          <TabsList className="mb-8">
            ...
            <TabsTrigger value="about">
              <Icon name="Info" className="mr-2 h-4 w-4" />О курсе
            </TabsTrigger>
                  ...
                  <ul className="space-y-2">
                    {course.skills.map((skill, index) => (
                      <li key={index} className="flex items-start">
                        <Icon
                          name="Check"
                          className="mr-2 h-5 w-5 text-green-600 mt-0.5"
                        />
                        <span>{skill}</span>
                      </li>
                    ))}
                  ...
                  <ul className="space-y-2">
                    {course.prerequisites.map((prerequisite, index) => (
                      <li key={index} className="flex items-start">
                        <Icon
                          name="ArrowRight"
                          className="mr-2 h-5 w-5 text-purple-600 mt-0.5"
                        />
