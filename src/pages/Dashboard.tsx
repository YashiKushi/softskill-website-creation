    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="sticky top-0 z-50 bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            ...
            <Badge variant="outline" className="bg-purple-100 text-purple-600">Кабинет</Badge>
          </Link>
          
          <div className="flex items-center gap-4">
            <span className="hidden md:inline-block text-gray-700">Привет, {user?.name || "Студент"}!</span>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Отслеживайте прогресс обучения и управляйте своими курсами</p>
        </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="font-semibold text-lg">{user?.name || "Студент"}</h3>
                  <p className="text-gray-500">{user?.email}</p>
                </div>
                
                <div className="mt-6 space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Пройдено курсов:</span>
                    <span className="font-medium">0 из {mockCourses.length}</span>
                  </div>
                  <div className="flex justify-between items-center">
          ...
          <div className="lg:col-span-3">
            <Tabs defaultValue="my-courses">
                ...
                {activeCourses.length === 0 ? (
                  <Card>
                    <CardContent className="flex flex-col items-center justify-center py-12">
                      <Icon name="BookX" className="h-12 w-12 text-gray-400 mb-4" />
                      <h3 className="text-xl font-medium mb-2">У вас еще нет активных курсов</h3>
                      <p className="text-gray-500 mb-4 text-center">Начните обучение, выбрав курс из списка доступных</p>
                      ...
                      <Card key={course.id} className="hover:shadow-md transition-shadow">
                        ...
                        <CardContent className="pb-2">
                          ...
                          <p className="text-sm text-gray-600 mb-2">
                            Завершено {course.completedLessons} из {course.lessons} уроков
                          </p>
                        </CardContent>
                        <CardFooter>
                    ...
                    <Card key={course.id} className="hover:shadow-md transition-shadow">
                      ...
                      <CardContent>
                        ...
                        <p className="text-sm text-gray-600">
                          <Icon name="Book" className="inline mr-1 h-4 w-4" /> {course.lessons} уроков
                        </p>
                      </CardContent>
                      <CardFooter>
                        <Button className="w-full bg-purple-600 hover:bg-purple-700">
              ...
              <TabsContent value="certificates">
                ...
                <Card>
                  <CardContent className="flex flex-col items-center justify-center py-12">
                    <Icon name="Award" className="h-12 w-12 text-gray-400 mb-4" />
                    <h3 className="text-xl font-medium mb-2">У вас еще нет сертификатов</h3>
                    <p className="text-gray-500 mb-4 text-center">Пройдите курс полностью, чтобы получить сертификат о его завершении</p>
                    <Button className="bg-purple-600 hover:bg-purple-700">
                      <Icon name="BookOpen" className="mr-2 h-4 w-4" />
